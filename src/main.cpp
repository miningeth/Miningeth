...
const string strMessageMagic = "MiningEth Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
            ...
            int64_t nSubsidy = 11 * COIN;

            if(nBestHeight == 0)
            {
            nSubsidy = 513333 * COIN;
            }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MiningEth", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1469027707, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = "Life is good";
        CTransaction txNew;
        txNew.nTime = 1469027707;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1469027707;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 164699 : 164699;
        ...
        assert(block.hashMerkleRoot == uint256("0xd62b994297328279e536124b6743290b38e70001b8ddd5878c8d0fe65ec4b991"));
...
unsigned char pchMessageStart[4] = { 0x48, 0x2e, 0x8d, 0x92 };
